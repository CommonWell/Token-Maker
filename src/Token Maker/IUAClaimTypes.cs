...
{
    /// <summary>
    ///     Claims defined in the IHE Internet User Authorization (IUA) profile.
    /// </summary>
    public static class IUAClaimTypes
    {
        ...
        ///     different data object. The jti claim can be used to prevent the JWT from being replayed. The jti value is a case
        ///     sensitive string. Use of this claim is REQUIRED per the IHE Internet User Authorization (IUA) profile.
        /// </summary>
        public const string JWTId = "jti";

        /// <summary>
        ///     The sub (subject) claim identifies the principal that is the subject of the JWT. The Claims in a JWT are normally
        ///     statements about the subject. The processing of this claim is generally application specific. The sub value is a
        ///     case sensitive string containing a StringOrURI value. Use of this claim is REQUIRED per the IHE Internet User
        ///     Authorization (IUA) profile.
        /// </summary>
